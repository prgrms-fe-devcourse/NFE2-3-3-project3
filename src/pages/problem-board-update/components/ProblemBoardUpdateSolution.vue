...
<template>
  ...
  <!-- 출처  -->
  <div v-if="source" class="text-gray-500 mt-4 p-4 border-b border-gray-300 mb-10 item-middle gap-2">
    출처 | 
    <input type="text" :value="source" @input="updateSource" class="border border-gray-300 rounded p-1 flex-grow" />
  </div>
</template>
