...
<template>
  <div class="flex flex-col items-center w-full">
    <div class="h-[124px] flex mt-[31px] items-center mb-[63px]">
      <div class="w-[124px] h-[124px] mr-[21px]">
        <RouterLink :to="`/exam-make/${route.params.problemSetId}`">
          <img
            src="../assets/icons/problem-set-board-detail/test-center-enter.svg"
            alt="시험장 입실"
        /></RouterLink>
      </div>
      <div class="h-[124px] mr-[196px] flex flex-col justify-between">
        ...
        <div class="flex w-[473px] h-[23px] ml-[7px] justify-between">
          ...
          <div class="flex justify-between w-10">
            <div>
              <img
                src="../assets/icons/problem-set-board-detail/thumbs-up.svg"
                alt="좋아요"
              />
            </div>
            <div>227</div>
      ...
      <div class="items-center w-10 h-10">
        <button @click="openMenu">
          <img
            src="../assets/icons/problem-set-board-detail/add-option.svg"
            alt="문제집 추가 설정"
          />
        </button>
      </div>
    </div>
    <ProblemTable :problems="problems" :showCheckbox="false" />
