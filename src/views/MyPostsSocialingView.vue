...
const mySocialingPosts = ref(null);
...
<template>
  <div class="bg-[#f4f4f4] h-screen p-4">
    ...
    <RouterLink v-for="mySocialingPost in mySocialingPosts" :to="`/socialing/${mySocialingPost.id}`">
      <ChannelPostCard :post="mySocialingPost" channelName="소셜링" />
    </RouterLink>
  </div>
</template>
<style scoped></style>
